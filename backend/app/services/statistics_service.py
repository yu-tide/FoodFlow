...
def get_mock_weekly_stats() -> WeeklyStatsResponse:
    return WeeklyStatsResponse(
        week_range="5/5 - 5/11",
        target_calories=2000,
        ...
        today_gap=230,
        daily_calories=[
            DailyCalories(day="周一", calories=1270),
            DailyCalories(day="周二", calories=2180),
            DailyCalories(day="周三", calories=2260),
            DailyCalories(day="周四", calories=1320),
            DailyCalories(day="周五", calories=920),
            DailyCalories(day="周六", calories=1300),
            DailyCalories(day="周日", calories=650),
        ],
        macro_trend=[
            MacroTrendPoint(day="周一", protein=78, carbs=152, fat=42),
            MacroTrendPoint(day="周二", protein=95, carbs=210, fat=55),
            MacroTrendPoint(day="周三", protein=110, carbs=260, fat=62),
            MacroTrendPoint(day="周四", protein=65, carbs=140, fat=35),
            MacroTrendPoint(day="周五", protein=40, carbs=95, fat=28),
            MacroTrendPoint(day="周六", protein=72, carbs=130, fat=40),
            MacroTrendPoint(day="周日", protein=30, carbs=80, fat=22),
        ],
        meal_distribution=[
            MealDistItem(name="早餐", calories=420, color="#FFB347"),
            MealDistItem(name="午餐", calories=560, color="#4CAF50"),
            MealDistItem(name="晚餐", calories=390, color="#7B68EE"),
            MealDistItem(name="加餐", calories=180, color="#FF7043"),
        ],
        last_week_comparison=LastWeekComparison(
            avg_calories_delta_pct=-5,
            protein_delta_pct=8,
            record_delta_days=2,
            avg_calories_last_week=1950,
            protein_last_week=72,
            record_days_last_week=5,
        ),
        ai_summary=[
            "本周饮食记录较稳定，建议继续保持。",
            "蛋白质摄入仍有提升空间，可增加鸡蛋、鱼肉、豆制品。",
            "建议控制高碳水餐次比例，增加蔬菜和优质脂肪。",
        ],
    )
